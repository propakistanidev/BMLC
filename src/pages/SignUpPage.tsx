...
//                     <h2 className="text-3xl font-semibold text-[#27272A] mt-12 text-center capitalize">Meet our coaches</h2>
//                     <p className='whitespace-nowrap text-center text-[#27272A] mb-10'>Learn more about their background and <br />their coaching experience</p>
...
//                     >Sign Up  <span className='ml-4'>→</span> </button>
