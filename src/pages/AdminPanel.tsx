    ...
    return (
        <div className="flex h-screen">
            ...
            <div className={`bg-white text-gray-600 p-6 transition-all flex flex-col justify-between ${collapsed ? 'w-20' : 'w-60'}`}>
                <div>
                    ...
                    <nav className="mt-10 space-y-4">
                        {navTabs.map((tab, idx) => (
                            <div
                                key={idx}
                                className="flex items-center gap-4 cursor-pointer hover:text-gray-700 hover:bg-purple-300 hover:font-semibold hover:rounded-lg py-2 px-2"
                            >
                ...
                <div className="mt-10">
                    <button
                        className={`flex items-center border-4 border-[#FF3737] rounded-lg py-2 gap-2 text-lg hover:text-purple-800 hover:font-bold transition-all duration-300
                ${collapsed ? 'justify-center px-2' : 'px-12'}`}
            ...
            <div className="flex-1 p-6 overflow-y-auto bg-[#F8F6FC]">
                ...
                <div className="mb-10">
                    ...
                    <div className="flex gap-4 overflow-x-auto pb-2">
                        {[1, 2, 3, 4, 5].map((item) => (
                            <div key={item} className="min-w-[250px] bg-white p-4 rounded-xl shadow">
