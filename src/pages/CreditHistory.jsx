        ...
        <div className="flex  bg-[#F8F6FC] min-h-screen">
            ...
            <div className="flex-1 p-6">
                ...
                <div className="bg-white rounded-xl shadow-md p-6 w-fit " >
                    <div className="bg-gradient-to-bl from-[#9363C340] via-white to-[#9363C430] w-[355px] h-[200px] rounded-xl shadow-md p-6  max-w-md mb-2 hover:scale-105 transition duration-200 ease-in-out">
                        ...
                        <table className="w-full text-sm text-left text-gray-700">
                            <thead className="border-b-2 border-gray-200">
                                <tr className="bg-[#F1EEF9]">
                                    ...
                                    <th className="py-2 px-4 font-bold ">Life Coach</th>
