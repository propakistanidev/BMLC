    ...
    return (
        <div className="flex flex-row justify-center items-start gap-20 py-[150px] px-4 w-full bg-white">
            ...
            <div className='max-w-[500px] w-full'>
                <h1 className="leading-snug md:text-[40px] text-[#454545] font-light capitalize mt-4 mb-6">About Us</h1>
                ...
                <p className="mt-4 text-base text-[[#27272A]] leading-7.5 font-light">Our mission is simple: to make personalized support <br />as easy and accessible as texting a best friend.<br /> Whether you need clarity, encouragement, or a plan <br />forward, we're here to help—right when you need it.</p>
            </div>
        </div>
    )
}
